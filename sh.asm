...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 2b 0f 00 00       	call   1320 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 f5 0e 00 00       	call   1320 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 92 0e 00 00       	call   1320 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 4a 0e 00 00       	call   1320 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 02 0e 00 00       	call   1320 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 7c 19 00 00       	push   $0x197c
     ...
     63b:	50                   	push   %eax
     63c:	68 84 19 00 00       	push   $0x1984
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67e:	50                   	push   %eax
     67f:	68 7c 19 00 00       	push   $0x197c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c5:	50                   	push   %eax
     6c6:	68 7c 19 00 00       	push   $0x197c
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     749:	68 6a 14 00 00       	push   $0x146a
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76b:	50                   	push   %eax
     76c:	68 6b 14 00 00       	push   $0x146b
     771:	6a 02                	push   $0x2
     773:	e8 d4 08 00 00       	call   104c <printf>
     778:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77b:	83 ec 0c             	sub    $0xc,%esp
     77e:	68 7a 14 00 00       	push   $0x147a
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e3:	68 81 14 00 00       	push   $0x1481
  ...
  if(peek(ps, es, ";")){
     ...
     7fd:	68 83 14 00 00       	push   $0x1483
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86b:	68 85 14 00 00       	push   $0x1485
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fa:	68 87 14 00 00       	push   $0x1487
  ...
  while(peek(ps, es, "<>")){
     ...
     984:	68 a4 14 00 00       	push   $0x14a4
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9ad:	68 a7 14 00 00       	push   $0x14a7
    ...
    panic("parseblock");
     ...
     9c7:	68 a9 14 00 00       	push   $0x14a9
  ...
  if(!peek(ps, es, ")"))
     ...
     9fd:	68 b4 14 00 00       	push   $0x14b4
    ...
    panic("syntax - missing )");
     ...
     a17:	68 b6 14 00 00       	push   $0x14b6
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a5b:	68 a7 14 00 00       	push   $0x14a7
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae5:	68 7a 14 00 00       	push   $0x147a
    ...
    if(argc >= MAXARGS)
     ...
     b1c:	68 c9 14 00 00       	push   $0x14c9
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b43:	68 d7 14 00 00       	push   $0x14d7
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba9:	8b 04 85 dc 14 00 00 	mov    0x14dc(,%eax,4),%eax
     bb0:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
     ...
     f7b:	83 ec 18             	sub    $0x18,%esp
     f7e:	8b 45 0c             	mov    0xc(%ebp),%eax
     f81:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     f84:	83 ec 04             	sub    $0x4,%esp
     f87:	6a 01                	push   $0x1
     f89:	8d 45 f4             	lea    -0xc(%ebp),%eax
     f8c:	50                   	push   %eax
     f8d:	ff 75 08             	push   0x8(%ebp)
     f90:	e8 63 ff ff ff       	call   ef8 <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fa1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fa8:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fac:	74 17                	je     fc5 <printint+0x2a>
     fae:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fb2:	79 11                	jns    fc5 <printint+0x2a>
    neg = 1;
     fb4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     fbb:	8b 45 0c             	mov    0xc(%ebp),%eax
     fbe:	f7 d8                	neg    %eax
     fc0:	89 45 ec             	mov    %eax,-0x14(%ebp)
     fc3:	eb 06                	jmp    fcb <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
     fcb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
     fd2:	8b 4d 10             	mov    0x10(%ebp),%ecx
     fd5:	8b 45 ec             	mov    -0x14(%ebp),%eax
     fd8:	ba 00 00 00 00       	mov    $0x0,%edx
     fdd:	f7 f1                	div    %ecx
     fdf:	89 d1                	mov    %edx,%ecx
     fe1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     fe4:	8d 50 01             	lea    0x1(%eax),%edx
     fe7:	89 55 f4             	mov    %edx,-0xc(%ebp)
     fea:	0f b6 91 8c 19 00 00 	movzbl 0x198c(%ecx),%edx
     ff1:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
     ff5:	8b 4d 10             	mov    0x10(%ebp),%ecx
     ff8:	8b 45 ec             	mov    -0x14(%ebp),%eax
     ffb:	ba 00 00 00 00       	mov    $0x0,%edx
    1000:	f7 f1                	div    %ecx
    1002:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1005:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1009:	75 c7                	jne    fd2 <printint+0x37>
  if(neg)
    100b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    100f:	74 2d                	je     103e <printint+0xa3>
    buf[i++] = '-';
    1011:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1014:	8d 50 01             	lea    0x1(%eax),%edx
    1017:	89 55 f4             	mov    %edx,-0xc(%ebp)
    101a:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    101f:	eb 1d                	jmp    103e <printint+0xa3>
    putc(fd, buf[i]);
    1021:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    1032:	50                   	push   %eax
    1033:	ff 75 08             	push   0x8(%ebp)
    1036:	e8 3d ff ff ff       	call   f78 <putc>
    103b:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    103e:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1042:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1046:	79 d9                	jns    1021 <printint+0x86>
}
    1048:	90                   	nop
    1049:	90                   	nop
    104a:	c9                   	leave  
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10a5:	50                   	push   %eax
    10a6:	ff 75 08             	push   0x8(%ebp)
    10a9:	e8 ca fe ff ff       	call   f78 <putc>
    ...
    10cd:	6a 0a                	push   $0xa
    10cf:	50                   	push   %eax
    10d0:	ff 75 08             	push   0x8(%ebp)
    10d3:	e8 c3 fe ff ff       	call   f9b <printint>
    ...
    10fd:	e8 99 fe ff ff       	call   f9b <printint>
    ...
    113b:	50                   	push   %eax
    113c:	ff 75 08             	push   0x8(%ebp)
    113f:	e8 34 fe ff ff       	call   f78 <putc>
    ...
    1168:	50                   	push   %eax
    1169:	ff 75 08             	push   0x8(%ebp)
    116c:	e8 07 fe ff ff       	call   f78 <putc>
    ...
    1189:	50                   	push   %eax
    118a:	ff 75 08             	push   0x8(%ebp)
    118d:	e8 e6 fd ff ff       	call   f78 <putc>
    ...
    119f:	e8 d4 fd ff ff       	call   f78 <putc>
    ...
    11b0:	50                   	push   %eax
    11b1:	ff 75 08             	push   0x8(%ebp)
    11b4:	e8 bf fd ff ff       	call   f78 <putc>
...
free(void *ap)
{
    ...
    11e1:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11e4:	8b 45 08             	mov    0x8(%ebp),%eax
    11e7:	83 e8 08             	sub    $0x8,%eax
    11ea:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11ed:	a1 0c 1a 00 00       	mov    0x1a0c,%eax
    11f2:	89 45 fc             	mov    %eax,-0x4(%ebp)
    11f5:	eb 24                	jmp    121b <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11f7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    11fa:	8b 00                	mov    (%eax),%eax
    11fc:	39 45 fc             	cmp    %eax,-0x4(%ebp)
    11ff:	72 12                	jb     1213 <free+0x35>
    1201:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1204:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1207:	77 24                	ja     122d <free+0x4f>
    1209:	8b 45 fc             	mov    -0x4(%ebp),%eax
    120c:	8b 00                	mov    (%eax),%eax
    120e:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1211:	72 1a                	jb     122d <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1213:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1216:	8b 00                	mov    (%eax),%eax
    1218:	89 45 fc             	mov    %eax,-0x4(%ebp)
    121b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    121e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1221:	76 d4                	jbe    11f7 <free+0x19>
    1223:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1226:	8b 00                	mov    (%eax),%eax
    1228:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    122b:	73 ca                	jae    11f7 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    122d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1230:	8b 40 04             	mov    0x4(%eax),%eax
    1233:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    123a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    123d:	01 c2                	add    %eax,%edx
    123f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1242:	8b 00                	mov    (%eax),%eax
    1244:	39 c2                	cmp    %eax,%edx
    1246:	75 24                	jne    126c <free+0x8e>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    12c6:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    12cd:	77 07                	ja     12d6 <morecore+0x16>
    nu = 4096;
    12cf:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    12d6:	8b 45 08             	mov    0x8(%ebp),%eax
    12d9:	c1 e0 03             	shl    $0x3,%eax
    12dc:	83 ec 0c             	sub    $0xc,%esp
    12df:	50                   	push   %eax
    12e0:	e8 7b fc ff ff       	call   f60 <sbrk>
    12e5:	83 c4 10             	add    $0x10,%esp
    12e8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    12eb:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    12ef:	75 07                	jne    12f8 <morecore+0x38>
    return 0;
    12f1:	b8 00 00 00 00       	mov    $0x0,%eax
    12f6:	eb 26                	jmp    131e <morecore+0x5e>
  hp = (Header*)p;
    12f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    12fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    12fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1301:	8b 55 08             	mov    0x8(%ebp),%edx
    1304:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1307:	8b 45 f0             	mov    -0x10(%ebp),%eax
    130a:	83 c0 08             	add    $0x8,%eax
    130d:	83 ec 0c             	sub    $0xc,%esp
    1310:	50                   	push   %eax
    1311:	e8 c8 fe ff ff       	call   11de <free>
    1316:	83 c4 10             	add    $0x10,%esp
  return freep;
    1319:	a1 0c 1a 00 00       	mov    0x1a0c,%eax
}
    131e:	c9                   	leave  
    131f:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1329:	83 c0 07             	add    $0x7,%eax
    132c:	c1 e8 03             	shr    $0x3,%eax
    132f:	83 c0 01             	add    $0x1,%eax
    1332:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1335:	a1 0c 1a 00 00       	mov    0x1a0c,%eax
    133a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    133d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1341:	75 23                	jne    1366 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1343:	c7 45 f0 04 1a 00 00 	movl   $0x1a04,-0x10(%ebp)
    134a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    134d:	a3 0c 1a 00 00       	mov    %eax,0x1a0c
    1352:	a1 0c 1a 00 00       	mov    0x1a0c,%eax
    1357:	a3 04 1a 00 00       	mov    %eax,0x1a04
    base.s.size = 0;
    135c:	c7 05 08 1a 00 00 00 	movl   $0x0,0x1a08
    1363:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13a7:	c1 e0 03             	shl    $0x3,%eax
    13aa:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    13ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13b0:	8b 55 ec             	mov    -0x14(%ebp),%edx
    13b3:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    13b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13b9:	a3 0c 1a 00 00       	mov    %eax,0x1a0c
      return (void*)(p + 1);
    13be:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13c1:	83 c0 08             	add    $0x8,%eax
    13c4:	eb 3b                	jmp    1401 <malloc+0xe1>
    }
    if(p == freep)
    13c6:	a1 0c 1a 00 00       	mov    0x1a0c,%eax
    13cb:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    13ce:	75 1e                	jne    13ee <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    13d0:	83 ec 0c             	sub    $0xc,%esp
    13d3:	ff 75 ec             	push   -0x14(%ebp)
    13d6:	e8 e5 fe ff ff       	call   12c0 <morecore>
    13db:	83 c4 10             	add    $0x10,%esp
    13de:	89 45 f4             	mov    %eax,-0xc(%ebp)
    13e1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    13e5:	75 07                	jne    13ee <malloc+0xce>
        return 0;
    13e7:	b8 00 00 00 00       	mov    $0x0,%eax
    13ec:	eb 13                	jmp    1401 <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    13fc:	e9 6d ff ff ff       	jmp    136e <malloc+0x4e>
  }
}
    1401:	c9                   	leave  
    1402:	c3                   	ret    
